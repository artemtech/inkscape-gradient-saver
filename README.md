...
## NEWS!! ##
- (2021-05-29) - v1.0.3 - Fixed inx problem and saved gradient from earlier version of inkscape not being loaded
- (2021-05-27) - v1.0.2 - Add Inkscape 1.1 support
...
- [Download Gradient Saver for Inkscape 1.0+](https://github.com/artemtech/inkscape-gradient-saver/releases/download/v1.0.2/inkscape-gradient-saver_1.0.3.zip)
